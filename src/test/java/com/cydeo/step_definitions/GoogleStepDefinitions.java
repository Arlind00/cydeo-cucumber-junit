...
public class GoogleStepDefinitions {
    ...
    GoogleSearchPage googleSearchPage = new GoogleSearchPage();         // we create object that can access methods in GoogleSearchPage
    ...
    public void userShouldSeeInTheResult(String expectedCapital) {
        //String actualValue = googleSearchPage.();
